              ...
              <div class="widget-content widget-content-area">
                  <div class="row">
                      <div class="col-md-6 mx-auto">
                          <form  action="{{route('services.update',$service->id)}}" method="POST" class="form-horizontal form-val-1" >
                               @csrf
                               @method('PATCH')
                              ...
                              <div class="control-group mb-4">
                                ...
                                <div class="controls">
                                    <input type="file" class="form-control" name="image" value="{{$service->image}}" required/>
                                    <p class="help-block"></p>
                                </div>
                            </div>
                              ...
                              <div class="control-group mb-4">
                                  ...
                                  <div class="controls">
                                      <textarea name="description" class="form-control" cols="30" rows="10" value="" required >{{$service->description}}</textarea>
                                      <p class="help-block"></p>
                                  </div>
                              </div>
                              ...
                              <div class="form-actions mt-5 mb-4">
                                  <button type="submit" class="btn btn-button-7">Enregistrer <i class="icon-ok icon-white"></i></button>
                              </div>
                          </form>
                      </div>
                  </div>
