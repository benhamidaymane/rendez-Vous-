                                          ...
                                          <td>
                                              <div class="toolbar">
                                                  ...
                                                  <ul class="toolbar-dropdown animated fadeInUp table-controls list-inline">
                                                    <li class="list-inline-item"><a  value='{{$patients->id}}'  id="show-patient"  class="bs-tooltip" data-original-title="View"><i class="flaticon-view-3"></i></a>
                                                      <li class="list-inline-item"><a href="{{route('admin.edit',$patients->id)}}" class="bs-tooltip" data-original-title="Edit"><i class="flaticon-edit-5"></i></a></li>
