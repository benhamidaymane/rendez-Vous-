                        ...
                        <div class="form-row mb-4">
                          ...
                          <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control" name="cin" placeholder="Ta156548">
                          </div>
                          <div class="form-group col-md-6">
                          ...
                          <div class="form-row mb-4">
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" name="telephone" class="form-control" placeholder="060000000" >
                              </div>
                              <div class="form-group col-md-6">
                                  <label >service</label>
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <div>
                                <input type="hidden" value="{{$users}}" name="hopital_id">
                              </div>
                          </div>
                        <button type="submit" class="btn btn-button-7 mb-4 mt-3">Ajouter</button>
                      </form>
                  </div>
                  @if ($errors->any())
